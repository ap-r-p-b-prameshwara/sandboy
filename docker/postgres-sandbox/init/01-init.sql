-- Sandbox Database Initialization Script
-- This script creates all required schemas for the Sandbox environment
-- Identical to Production for clone architecture
